...
if __name__ == '__main__':
    ...
    for game in games:
        ...
        if st.checkbox(f"{team__1} VS {team__2}"):
            ...
            h_2_h_team_2_graph_pdf = h_2h_pdf_plot_helper(all_scores, m2, s2, 'red', team__2, 'PDF', h_2_h_team_1_graph)
            ...
            h_2_h_team_2_graph_cdf = h_2h_cdf_plot_helper(all_scores, m2, s2, 'red', team__2, 'CDF', h_2_h_team_1_graph)
